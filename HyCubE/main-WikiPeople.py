...
if __name__ == '__main__':
    ...
    parser.add_argument("--lr", type=float, default=0.00035, nargs="?", help="Learning rate.")
    ...
    parser.add_argument("--dropout", type=float, default=0.5, nargs="?", help="dropout.")
    parser.add_argument("--dropout_3d", type=float, default=0.6, nargs="?", help="dropout_3d.")
    
    parser.add_argument("--padding", type=int, default=5, nargs="?", help="Convolutional padding (conv_kernel size).")
