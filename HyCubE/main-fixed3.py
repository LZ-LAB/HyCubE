...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_drop", type=float, default=0.20, nargs="?", help="input_drop.")
    parser.add_argument("--dropout", type=float, default=0.7, nargs="?", help="dropout.")
    parser.add_argument("--dropout_3d", type=float, default=0.4, nargs="?", help="dropout_3d.")
