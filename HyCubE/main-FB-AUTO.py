...
if __name__ == '__main__':
    ...
    parser.add_argument("--lr", type=float, default=0.00099, nargs="?", help="Learning rate.")
    parser.add_argument("--dr", type=float, default=0.968, nargs="?", help="Decay rate.")
    
    parser.add_argument("--input_drop", type=float, default=0.5, nargs="?", help="input_drop.")
