...
class Experiment:
    def __init__(self, num_iterations, batch_size, lr, dr, inp_drop, dropout, dropout_3d, padding, dembd, dembd1, max_ary):
        self.num_iterations = num_iterations
        self.batch_size = batch_size
        self.lr, self.dr = lr, dr
        self.inp_drop, self.dropout, self.dropout_3d = inp_drop, dropout, dropout_3d
    ...
    def train_and_eval(self):
        ...
        model = HyCubE(len(d.ent2id), len(d.rel2id), self.inp_drop, self.dropout, self.dropout_3d, self.padding, self.dembd, self.dembd1, self.max_ary, self.device)
        model.to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dropout", type=float, default=0.1, nargs="?", help="dropout.")
    parser.add_argument("--dropout_3d", type=float, default=0.2, nargs="?", help="dropout_3d.")
    
    parser.add_argument("--padding", type=int, default=2, nargs="?", help="Convolutional padding (conv_kernel size).")
    ...
    param['inp_drop'], param['dropout'], param['dropout_3d'] = args.inp_drop, args.dropout, args.dropout_3d
    ...
    Exp = Experiment(num_iterations=param['num_iterations'], batch_size=param['batch_size'], lr=param['lr'], dr=param['dr'],
                     inp_drop=param['inp_drop'], dropout=param['dropout'], dropout_3d=param['dropout_3d'], padding=param['padding'], 
