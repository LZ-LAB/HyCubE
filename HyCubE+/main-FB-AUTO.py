...
if __name__ == '__main__':
    ...
    parser.add_argument("--lr", type=float, default=0.00075, nargs="?", help="Learning rate.")
    parser.add_argument("--dr", type=float, default=0.977, nargs="?", help="Decay rate.")
    
    parser.add_argument("--input_drop", type=float, default=0.6, nargs="?", help="input_drop.")
    parser.add_argument("--dropout", type=float, default=0.2, nargs="?", help="dropout.")
    parser.add_argument("--dropout_3d", type=float, default=0.7, nargs="?", help="dropout_3d.")
