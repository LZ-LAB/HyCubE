...
if __name__ == '__main__':
    ...
    parser.add_argument("--dr", type=float, default=0.989, nargs="?", help="Decay rate.")
    
    parser.add_argument("--input_drop", type=float, default=0.3, nargs="?", help="input_drop.")
    parser.add_argument("--dropout", type=float, default=0, nargs="?", help="dropout.")
    parser.add_argument("--dropout_3d", type=float, default=0.8, nargs="?", help="dropout_3d.")
